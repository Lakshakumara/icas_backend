...
public interface ClaimRepo extends JpaRepository<Claim, Integer> {
    ...
    Page<Claim> getClaim(@Param("memberId") Integer memberId,
    ...
    @Modifying
    @Transactional
    @Query("update Claim c set c.deductionAmount=:deductionAmount, c.paidAmount=:paidAmount,c.claimStatus=:claimStatus" +
            " where c.id=:id")
